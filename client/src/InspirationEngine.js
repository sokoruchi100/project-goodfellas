    ...
    return (
        <div>
            ...
            <div className="relative bg-whitesmoke w-full h-[3556px] overflow-hidden text-left text-[50px] text-secondary font-urbanist">
                <div className="absolute top-[0px] left-[70px] w-[1370px] h-[3556px] bg-[url(/public/component-1@3x.png)] bg-cover bg-no-repeat bg-[top]">
                ...
                <div className="absolute top-[3464px] left-[561px] w-[266px] h-[57px] text-16xl text-gray">
