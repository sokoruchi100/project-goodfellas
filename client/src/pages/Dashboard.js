    ...
    <div>
        ...
        <div className="flex-initial mt-[100px] pl-12">
          ...
          >
            <div className="ml-24 text-[80px] font-extrabold tracking-wide text-yellow-200">
              With{" "}
              <span className="text-zinc-800 bg-slate-100 font-[11000] transition duration-300 ease-in-out hover:bg-[#40659A]">
                Nothing
              </span>
            </div>
          </motion.div>
      ...
      <div className="ml-[550px] mt-8 z-3">
        <button class="text-zinc-100 font-extralight transition ease-in-out delay-150 bg-blue-500 hover:translate-x-5 hover:bg-yellow-200 duration-300 hover:text-zinc-800">
          <a
            className="transition ease-in-out delay-150 hover:text-zinc-800"
            href="/inspirationengine"
          >
            Generate new idea
          </a>
        </button>
      ...
      <svg
        className="-z-1 absolute ml-[700px]"
        width="270"
        height="270"
        viewBox="0 0 64 64"
      ...
      <svg
        className="-z-1 absolute ml-[700px] transition duration-300 ease-in-out hover:-translate-y-3 hover:-translate-x-4"
        width="270"
        height="270"
        viewBox="0 0 64 64"
        xmlns="http://www.w3.org/2000/svg"
      ...
      <svg
        className="-z-1 absolute top-0 right-0 mr-[90px] mt-[50px]"
        width="400"
        height="400"
        viewBox="0 0 64 64"
        xmlns="http://www.w3.org/2000/svg"
      ...
      <svg
        className="-z-1 absolute top-0 right-0 mr-[90px] mt-[50px] transition duration-300 ease-in-out hover:-translate-y-3 hover:-translate-x-3"
        width="400"
        height="400"
        viewBox="0 0 64 64"
        xmlns="http://www.w3.org/2000/svg"
