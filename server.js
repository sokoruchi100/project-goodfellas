...
app.get(
  ...
  async (req, res) => {
    try {
      const { channelId, channelName, videoTitles } = await fetchChannelIdAndVideoTitles(
...
function addUser(id, username)
{
  ...
  const query = "INSERT INTO Users (id, channelId, channelName, dateOfCreation) VALUES (NULL, ?, ?, ?)";
